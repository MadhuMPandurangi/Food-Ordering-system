...
String query = "delete from dbd where itemnames='"+itemnames+"'";//here, where the value is to stored and in which column is mentioned
...
response.sendRedirect("dbd_delete.jsp");//going back to the page where it is redirected
%>
