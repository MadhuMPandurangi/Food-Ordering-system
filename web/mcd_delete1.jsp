...
String query = "delete from mcd where itemnames='"+itemnames+"'";//here, where the value is to stored and in which column is mentioned
...
response.sendRedirect("mcd_delete.jsp");//going back to the page where it is redirected
%>
