...
<html>
    <head>
        ...
        <title>hari sandwitch menu</title>
    </head>
     <style>
         body {
...
<div id="main">
  ...
  <span style="font-size:30px;cursor:pointer; " onclick="openNav()">&#9776; </span>
        ...
        <table align="center" cellpadding="2" cellspacing="2" style="border-collapse: collapse;">
            <caption style=" font-weight: bolder;">Hari Sandwich Menu</caption>
            
            <tr style="background-color: #c60b0b;">
                <td><b>slno</b></td>
                <td><b>itemnames</b></td>
                <td><b>price</b></td>
            </tr>
...
<tr style="color: #d5d50f;">
   
                <td><%=resultSet.getString("itemid") %></td>
                <td><%=resultSet.getString("itemnames") %></td>
                <td><%=resultSet.getString("price") %></td>
                <td><a href="hariorder.jsp?order=<%=resultSet.getString("itemnames")%>&&price=<%=resultSet.getString("price")%>" >Order</a></td>
            </tr>
